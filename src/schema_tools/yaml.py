...
yaml.add_constructor(
  yaml.resolver.BaseResolver.DEFAULT_SEQUENCE_TAG, list_constructor, YamlSchemaLoader
)
...
yaml.add_constructor(
  yaml.resolver.BaseResolver.DEFAULT_MAPPING_TAG, dict_constructor, YamlSchemaLoader
)
